...
const CameraHandler = {
    ...
    _updateVideoDisplay() {
        ...
        // NON APPLICARE PIÙ SPECCHIO - Mostra sempre l'anteprima normale
        this.domElements.cameraFeed.style.transform = 'scaleX(1)';
        this.domElements.cameraFeed.style.webkitTransform = 'scaleX(1)'; // Per Safari
        this.domElements.cameraFeed.style.transition = 'transform 0.3s ease';

        console.log("📷 Anteprima normale per tutte le fotocamere");
    },
