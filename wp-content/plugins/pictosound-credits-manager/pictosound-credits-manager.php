...
require_once plugin_dir_path(__FILE__) . 'shortcodes/login-modern.php';
require_once plugin_dir_path(__FILE__) . 'shortcodes/credit-packages.php';
require_once plugin_dir_path(__FILE__) . 'shortcodes/payment-return.php';
require_once plugin_dir_path(__FILE__) . 'shortcodes/login-form.php';
require_once plugin_dir_path(__FILE__) . 'shortcodes/registration-form.php';
require_once plugin_dir_path(__FILE__) . 'shortcodes/credits-balance.php';
require_once plugin_dir_path(__FILE__) . 'shortcodes/user-area.php';
require_once plugin_dir_path(__FILE__) . 'shortcodes/user-name.php';
require_once plugin_dir_path(__FILE__) . 'shortcodes/user-email.php';
require_once plugin_dir_path(__FILE__) . 'shortcodes/edit-profile.php';
require_once plugin_dir_path(__FILE__) . 'shortcodes/ms-display-credits.php';
/**
